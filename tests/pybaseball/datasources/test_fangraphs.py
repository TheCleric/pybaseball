...
from pybaseball.datasources.column_mapper import (
    GenericColumnMapper,
...
from pybaseball.datasources.fangraphs import (
    ...
    FangraphsTeamBattingStats,
    FangraphsTeamPitchingStats,
    FangraphsTeamFieldingStats,
)
...
class TestDatasourceFangraphs:
    def test_get_table(self, sample_html, sample_processed_result):
        actual_result = (
            FangraphsDataTable()
            .html_accessor.get_tabular_data_from_html(sample_html)
            .reset_index(drop=True)
        )
    ...
    def test_batting_stats(
        ...
        expected_url = FangraphsDataTable().html_accessor._create_url(
            _FG_LEADERS_URL,
            {
                "pos": "all",
                "stats": "bat",
        ...
        batting_stats_result = FangraphsBattingStats()(season).reset_index(drop=True)
    ...
    def test_pitching_stats(
        ...
        pitching_stats_result = FangraphsPitchingStats()(season).reset_index(drop=True)
    ...
    def test_team_batting(
        ...
        team_batting_result = FangraphsTeamBattingStats()(season).reset_index(drop=True)
    ...
    def test_team_fielding(
        ...
        team_fielding_result = FangraphsTeamFieldingStats()(season).reset_index(
            drop=True
        )
    ...
    def test_team_pitching(
        ...
        team_pitching_result = FangraphsTeamPitchingStats()(season).reset_index(
            drop=True
        )
